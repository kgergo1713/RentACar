...
1: Bérlők (emberek ikon) (USERS)
	Magánszemély esetén:
		Név, Cím, Telefonszám, Anyja neve, Születési hely, Születési idő, Személyi igazolvány száma, Jogosítvány száma
	Cég esetén:
		Cégnév, Székhely, Cégjegyzékszám, Adószám
		Bérbevevő, ami cég esetén több is lehet, adatok a Magánszemélyek lista szerint
...
3: Sablonok (dokumentum ikon) (TEMPLATES)
	...
	Fejléc
	Lábléc
	Dokumentum törzs hivatkozással a USERS és CARS táblák celláira, formázással, szabad szöveges kitöltendő mezőkkel, lásd SampleDocument.jpg, például: Sérülések, Üzemanyagszint (választható 10%-os léptékkel, 0..100% között), Bérlés várható időtartama [nap], Átadás dátuma (dátum, idő), ...
